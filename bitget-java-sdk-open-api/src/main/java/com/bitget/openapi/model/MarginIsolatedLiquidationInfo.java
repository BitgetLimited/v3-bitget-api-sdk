...
public class MarginIsolatedLiquidationInfo {
  ...
  public MarginIsolatedLiquidationInfo() {
  }

  public MarginIsolatedLiquidationInfo ctime(String ctime) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo liqEndTime(String liqEndTime) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo liqFee(String liqFee) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo liqId(String liqId) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo liqRisk(String liqRisk) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo liqStartTime(String liqStartTime) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo symbol(String symbol) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo totalAssets(String totalAssets) {
  ...
  **/
  ...
  public MarginIsolatedLiquidationInfo totalDebt(String totalDebt) {
  ...
  **/
   ...
   * @return the MarginIsolatedLiquidationInfo instance itself
   */
  public MarginIsolatedLiquidationInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MarginIsolatedLiquidationInfo marginIsolatedLiquidationInfo = (MarginIsolatedLiquidationInfo) o;
    return Objects.equals(this.ctime, marginIsolatedLiquidationInfo.ctime) &&
        Objects.equals(this.liqEndTime, marginIsolatedLiquidationInfo.liqEndTime) &&
        Objects.equals(this.liqFee, marginIsolatedLiquidationInfo.liqFee) &&
        Objects.equals(this.liqId, marginIsolatedLiquidationInfo.liqId) &&
        Objects.equals(this.liqRisk, marginIsolatedLiquidationInfo.liqRisk) &&
        Objects.equals(this.liqStartTime, marginIsolatedLiquidationInfo.liqStartTime) &&
        Objects.equals(this.symbol, marginIsolatedLiquidationInfo.symbol) &&
        Objects.equals(this.totalAssets, marginIsolatedLiquidationInfo.totalAssets) &&
        Objects.equals(this.totalDebt, marginIsolatedLiquidationInfo.totalDebt)&&
        Objects.equals(this.additionalProperties, marginIsolatedLiquidationInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ctime, liqEndTime, liqFee, liqId, liqRisk, liqStartTime, symbol, totalAssets, totalDebt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MarginIsolatedLiquidationInfo {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MarginIsolatedLiquidationInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MarginIsolatedLiquidationInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MarginIsolatedLiquidationInfo is not found in the empty JSON string", MarginIsolatedLiquidationInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarginIsolatedLiquidationInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarginIsolatedLiquidationInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarginIsolatedLiquidationInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarginIsolatedLiquidationInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<MarginIsolatedLiquidationInfo>() {
           @Override
           public void write(JsonWriter out, MarginIsolatedLiquidationInfo value) throws IOException {
           ...
           @Override
           public MarginIsolatedLiquidationInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MarginIsolatedLiquidationInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MarginIsolatedLiquidationInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MarginIsolatedLiquidationInfo
  * @throws IOException if the JSON string is invalid with respect to MarginIsolatedLiquidationInfo
  */
  public static MarginIsolatedLiquidationInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarginIsolatedLiquidationInfo.class);
  }

 /**
  * Convert an instance of MarginIsolatedLiquidationInfo to an JSON string
  *
  * @return JSON string
  */
