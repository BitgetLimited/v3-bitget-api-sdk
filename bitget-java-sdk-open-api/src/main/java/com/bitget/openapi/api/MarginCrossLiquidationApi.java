...
public class MarginCrossLiquidationApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MarginCrossLiquidationApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MarginCrossLiquidationApi(ApiClient apiClient) {
    ...
    public okhttp3.Call liquidationListCall(String startTime, String endTime, String pageSize, String pageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/margin/v1/cross/liquidation/list";
     ...
     * @param pageSize pageSize (optional)
     * @param pageId pageId (optional)
     * @return ApiResponse&lt;ApiResponseResultOfMarginLiquidationInfoResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
