...
public class MarginCrossRepayApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MarginCrossRepayApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MarginCrossRepayApi(ApiClient apiClient) {
    ...
    public okhttp3.Call repayListCall(String startTime, String coin, String repayId, String endTime, String pageSize, String pageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/margin/v1/cross/repay/list";
     ...
     * @param pageSize pageSize (optional)
     * @param pageId pageId (optional)
     * @return ApiResponse&lt;ApiResponseResultOfMarginRepayInfoResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
