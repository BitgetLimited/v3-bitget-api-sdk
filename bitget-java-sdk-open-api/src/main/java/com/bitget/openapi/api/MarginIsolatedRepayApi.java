...
import com.bitget.openapi.model.ApiResponseResultOfMarginIsolatedRepayInfoResult;
...
public class MarginIsolatedRepayApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MarginIsolatedRepayApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MarginIsolatedRepayApi(ApiClient apiClient) {
    ...
    public okhttp3.Call repayList1Call(String startTime, String symbol, String coin, String repayId, String endTime, String pageSize, String pageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/margin/v1/isolated/repay/list";
        ...
        if (repayId != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("repayId", repayId));
        }
     ...
     * @param pageSize pageSize (optional)
     * @param pageId pageId (optional)
     * @return ApiResponse&lt;ApiResponseResultOfMarginIsolatedRepayInfoResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
