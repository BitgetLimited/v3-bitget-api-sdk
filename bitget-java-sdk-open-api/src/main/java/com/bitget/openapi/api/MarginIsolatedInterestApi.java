...
public class MarginIsolatedInterestApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MarginIsolatedInterestApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MarginIsolatedInterestApi(ApiClient apiClient) {
    ...
    public okhttp3.Call interestList1Call(String startTime, String symbol, String coin, String pageSize, String pageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/margin/v1/isolated/interest/list";
     ...
     * @param pageSize pageSize (optional)
     * @param pageId pageId (optional)
     * @return ApiResponse&lt;ApiResponseResultOfMarginIsolatedInterestInfoResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
