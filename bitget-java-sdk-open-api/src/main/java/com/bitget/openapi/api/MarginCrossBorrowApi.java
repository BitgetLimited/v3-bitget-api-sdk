...
import com.bitget.openapi.model.ApiResponseResultOfMarginLoanInfoResult;
...
public class MarginCrossBorrowApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public MarginCrossBorrowApi() {
        this(Configuration.getDefaultApiClient());
    }

    public MarginCrossBorrowApi(ApiClient apiClient) {
    ...
    public okhttp3.Call loanListCall(String startTime, String coin, String endTime, String loanId, String pageSize, String pageId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/margin/v1/cross/loan/list";
     ...
     * @param pageSize pageSize (optional)
     * @param pageId pageId (optional)
     * @return ApiResponse&lt;ApiResponseResultOfMarginLoanInfoResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
