...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfMarginSystemResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_public_currencies_oapg(
        self,
...
class MarginPublicCurrencies(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_public_currencies(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def margin_public_currencies(
        ...
        return self._margin_public_currencies_oapg(
