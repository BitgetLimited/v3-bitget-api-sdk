...
RepayIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'repayId': typing.Union[RepayIdSchema, str, ],
...
request_query_repay_id = api_client.QueryParameter(
    name="repayId",
    schema=RepayIdSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginIsolatedRepayInfoResult
...
class IsolateRepayList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def isolate_repay_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def isolate_repay_list(
        ...
        return self._isolate_repay_list_oapg(
