...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfMarginIsolatedAssetsPopulationResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_isolated_account_assets_oapg(
        self,
...
class MarginIsolatedAccountAssets(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_isolated_account_assets(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def margin_isolated_account_assets(
        ...
        return self._margin_isolated_account_assets_oapg(
