...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginCrossAssetsRiskResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_cross_account_risk_rate_oapg(
        self,
...
class MarginCrossAccountRiskRate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_cross_account_risk_rate(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def margin_cross_account_risk_rate(
        ...
        return self._margin_cross_account_risk_rate_oapg(
