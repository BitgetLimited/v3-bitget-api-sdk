...
# body param
SchemaForRequestBodyApplicationJson = MarginIsolatedAssetsRiskRequest


request_body_margin_isolated_assets_risk_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfMarginIsolatedAssetsRiskResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_isolated_account_risk_rate_oapg(
        self,
    ...
    def _margin_isolated_account_risk_rate_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_margin_isolated_assets_risk_request.serialize(body, content_type)
...
class MarginIsolatedAccountRiskRate(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_isolated_account_risk_rate(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def margin_isolated_account_risk_rate(
        ...
        return self._margin_isolated_account_risk_rate_oapg(
            body=body,
