...
# body param
SchemaForRequestBodyApplicationJson = CloseTrackingOrderRequest


request_body_close_tracking_order_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfboolean
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_trace_close_tracking_order_oapg(
        self,
    ...
    def _spot_trace_close_tracking_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_close_tracking_order_request.serialize(body, content_type)
...
class SpotTraceCloseTrackingOrder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def spot_trace_close_tracking_order(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def spot_trace_close_tracking_order(
        ...
        return self._spot_trace_close_tracking_order_oapg(
            body=body,
