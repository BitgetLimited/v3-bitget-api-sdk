...
# body param
SchemaForRequestBodyApplicationJson = MarginCrossLimitRequest


request_body_margin_cross_limit_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginCrossBorrowLimitResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_cross_account_borrow_oapg(
        self,
    ...
    def _margin_cross_account_borrow_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_margin_cross_limit_request.serialize(body, content_type)
...
class MarginCrossAccountBorrow(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_cross_account_borrow(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def margin_cross_account_borrow(
        ...
        return self._margin_cross_account_borrow_oapg(
            body=body,
