...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfMarginIsolatedLevelResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_isolated_public_tier_data_oapg(
        self,
...
class MarginIsolatedPublicTierData(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_isolated_public_tier_data(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def margin_isolated_public_tier_data(
        ...
        return self._margin_isolated_public_tier_data_oapg(
