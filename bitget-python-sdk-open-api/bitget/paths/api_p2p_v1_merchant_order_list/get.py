...
OrderNoSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'orderNo': typing.Union[OrderNoSchema, str, ],
...
request_query_order_no = api_client.QueryParameter(
    name="orderNo",
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMerchantOrderResult
...
class MerchantOrderList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def merchant_order_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def merchant_order_list(
        ...
        return self._merchant_order_list_oapg(
