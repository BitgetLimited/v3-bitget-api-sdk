...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginIsolatedLiquidationInfoResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _isolated_liquidation_list_oapg(
        self,
...
class IsolatedLiquidationList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def isolated_liquidation_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def isolated_liquidation_list(
        ...
        return self._isolated_liquidation_list_oapg(
