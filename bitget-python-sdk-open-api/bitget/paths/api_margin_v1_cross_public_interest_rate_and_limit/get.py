...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfMarginCrossRateAndLimitResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_cross_public_interest_rate_and_limit_oapg(
        self,
...
class MarginCrossPublicInterestRateAndLimit(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_cross_public_interest_rate_and_limit(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def margin_cross_public_interest_rate_and_limit(
        ...
        return self._margin_cross_public_interest_rate_and_limit_oapg(
