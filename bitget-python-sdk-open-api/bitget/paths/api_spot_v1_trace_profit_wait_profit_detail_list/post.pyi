...
# body param
SchemaForRequestBodyApplicationJson = WaitProfitDetailListRequest


request_body_wait_profit_detail_list_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfTraderWaitProfitDetailListResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_trace_wait_profit_detail_list_oapg(
        self,
    ...
    def _spot_trace_wait_profit_detail_list_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_wait_profit_detail_list_request.serialize(body, content_type)
...
class SpotTraceWaitProfitDetailList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def spot_trace_wait_profit_detail_list(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def spot_trace_wait_profit_detail_list(
        ...
        return self._spot_trace_wait_profit_detail_list_oapg(
            body=body,
