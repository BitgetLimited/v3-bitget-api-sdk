...
# body param
SchemaForRequestBodyApplicationJson = MarginBatchOrdersRequest


request_body_margin_order_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginBatchPlaceOrderResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_isolated_batch_place_order_oapg(
        self,
    ...
    def _margin_isolated_batch_place_order_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_margin_order_request.serialize(body, content_type)
...
class MarginIsolatedBatchPlaceOrder(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_isolated_batch_place_order(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def margin_isolated_batch_place_order(
        ...
        return self._margin_isolated_batch_place_order_oapg(
            body=body,
