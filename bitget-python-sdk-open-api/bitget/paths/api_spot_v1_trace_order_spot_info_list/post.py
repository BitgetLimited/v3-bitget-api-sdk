...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfSpotInfoResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_trace_spot_info_list_oapg(
        self,
...
class SpotTraceSpotInfoList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def spot_trace_spot_info_list(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def spot_trace_spot_info_list(
        ...
        return self._spot_trace_spot_info_list_oapg(
