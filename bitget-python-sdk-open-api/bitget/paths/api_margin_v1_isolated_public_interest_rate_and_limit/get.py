...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfListOfMarginIsolatedRateAndLimitResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_isolated_public_interest_rate_and_limit_oapg(
        self,
...
class MarginIsolatedPublicInterestRateAndLimit(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_isolated_public_interest_rate_and_limit(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def margin_isolated_public_interest_rate_and_limit(
        ...
        return self._margin_isolated_public_interest_rate_and_limit_oapg(
