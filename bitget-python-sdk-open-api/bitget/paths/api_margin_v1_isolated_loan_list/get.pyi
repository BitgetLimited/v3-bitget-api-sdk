...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginIsolatedLoanInfoResult
...
class IsolatedLoanList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def isolated_loan_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def isolated_loan_list(
        ...
        return self._isolated_loan_list_oapg(
