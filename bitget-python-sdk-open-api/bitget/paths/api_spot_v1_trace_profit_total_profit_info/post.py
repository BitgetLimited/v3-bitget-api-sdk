...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfTraderTotalProfitResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _spot_trace_total_profit_info_oapg(
        self,
...
class SpotTraceTotalProfitInfo(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def spot_trace_total_profit_info(
        self,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        timeout: typing.Optional[typing.Union[int, typing.Tuple]] = None,
    ...
    def spot_trace_total_profit_info(
        ...
        return self._spot_trace_total_profit_info_oapg(
