...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginInterestInfoResult
...
class CrossInterestList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def cross_interest_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def cross_interest_list(
        ...
        return self._cross_interest_list_oapg(
