...
MarginTypeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'marginType': typing.Union[MarginTypeSchema, str, ],
...
request_query_margin_type = api_client.QueryParameter(
    name="marginType",
    schema=MarginTypeSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginIsolatedFinFlowResult
...
class IsolatedFinList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def isolated_fin_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def isolated_fin_list(
        ...
        return self._isolated_fin_list_oapg(
