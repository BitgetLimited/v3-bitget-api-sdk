...
# body param
SchemaForRequestBodyApplicationJson = MarginIsolatedMaxBorrowRequest


request_body_margin_isolated_max_borrow_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginIsolatedMaxBorrowResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_isolated_account_max_borrowable_amount_oapg(
        self,
    ...
    def _margin_isolated_account_max_borrowable_amount_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_margin_isolated_max_borrow_request.serialize(body, content_type)
...
class MarginIsolatedAccountMaxBorrowableAmount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_isolated_account_max_borrowable_amount(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,],
        content_type: typing_extensions.Literal["application/json"] = ...,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def margin_isolated_account_max_borrowable_amount(
        ...
        return self._margin_isolated_account_max_borrowable_amount_oapg(
            body=body,
