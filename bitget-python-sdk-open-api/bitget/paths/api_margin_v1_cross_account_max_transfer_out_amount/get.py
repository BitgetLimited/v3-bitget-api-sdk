...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginCrossAssetsResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _margin_cross_account_max_transfer_out_amount_oapg(
        self,
...
class MarginCrossAccountMaxTransferOutAmount(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def margin_cross_account_max_transfer_out_amount(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def margin_cross_account_max_transfer_out_amount(
        ...
        return self._margin_cross_account_max_transfer_out_amount_oapg(
