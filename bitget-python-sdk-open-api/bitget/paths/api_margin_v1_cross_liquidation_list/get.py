...
SchemaFor200ResponseBodyApplicationJson = ApiResponseResultOfMarginLiquidationInfoResult
...
class BaseApi(api_client.Api):
    @typing.overload
    def _cross_liquidation_list_oapg(
        self,
...
class CrossLiquidationList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def cross_liquidation_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def cross_liquidation_list(
        ...
        return self._cross_liquidation_list_oapg(
