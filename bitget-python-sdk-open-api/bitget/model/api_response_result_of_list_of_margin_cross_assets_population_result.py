...
class ApiResponseResultOfListOfMarginCrossAssetsPopulationResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginCrossAssetsPopulationResult']:
                        return MarginCrossAssetsPopulationResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginCrossAssetsPopulationResult'], typing.List['MarginCrossAssetsPopulationResult']],
                ...
                def __getitem__(self, i: int) -> 'MarginCrossAssetsPopulationResult':
