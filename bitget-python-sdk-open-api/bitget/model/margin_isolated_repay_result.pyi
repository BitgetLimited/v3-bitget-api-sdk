...
class MarginIsolatedRepayResult(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clientOid", "coin", "remainDebtAmount", "repayAmount", "symbol", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clientOid", "coin", "remainDebtAmount", "repayAmount", "symbol", ], str]):
