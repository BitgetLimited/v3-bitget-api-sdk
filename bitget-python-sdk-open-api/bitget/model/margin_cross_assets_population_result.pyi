...
class MarginCrossAssetsPopulationResult(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["available", "borrow", "coin", "ctime", "frozen", "interest", "net", "totalAmount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["available", "borrow", "coin", "ctime", "frozen", "interest", "net", "totalAmount", ], str]):
