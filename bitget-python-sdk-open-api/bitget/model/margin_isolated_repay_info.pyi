...
class MarginIsolatedRepayInfo(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["repayId"]) -> MetaOapg.properties.repayId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "coin", "ctime", "interest", "repayId", "symbol", "totalAmount", "type", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["repayId"]) -> typing.Union[MetaOapg.properties.repayId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "coin", "ctime", "interest", "repayId", "symbol", "totalAmount", "type", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        repayId: typing.Union[MetaOapg.properties.repayId, str, schemas.Unset] = schemas.unset,
