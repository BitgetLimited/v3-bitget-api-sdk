...
class ApiResponseResultOfListOfMarginIsolatedLevelResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginIsolatedLevelResult']:
                        return MarginIsolatedLevelResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginIsolatedLevelResult'], typing.List['MarginIsolatedLevelResult']],
                ...
                def __getitem__(self, i: int) -> 'MarginIsolatedLevelResult':
