...
class ApiResponseResultOfOrderHistoryListResult(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['OrderHistoryListResult']:
                return OrderHistoryListResult
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'OrderHistoryListResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['OrderHistoryListResult', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['OrderHistoryListResult', schemas.Unset] = schemas.unset,
