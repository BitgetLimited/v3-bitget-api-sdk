...
class FiatPaymentDetailInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "required", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "required", "type", ], str]):
