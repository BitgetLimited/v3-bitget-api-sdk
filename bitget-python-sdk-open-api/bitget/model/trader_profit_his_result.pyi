...
class TraderProfitHisResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["coinName", "date", "profit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["coinName", "date", "profit", ], str]):
