...
class MarginTradeDetailInfoResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class fills(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginTradeDetailInfo']:
                        return MarginTradeDetailInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginTradeDetailInfo'], typing.List['MarginTradeDetailInfo']],
                ...
                def __getitem__(self, i: int) -> 'MarginTradeDetailInfo':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fills", "maxId", "minId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fills", "maxId", "minId", ], str]):
