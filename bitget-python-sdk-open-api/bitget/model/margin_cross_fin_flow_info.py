...
class MarginCrossFinFlowInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "balance", "coin", "ctime", "fee", "marginId", "marginType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "balance", "coin", "ctime", "fee", "marginId", "marginType", ], str]):
