...
class MarginIsolatedLoanInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "coin", "ctime", "loanId", "symbol", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "coin", "ctime", "loanId", "symbol", "type", ], str]):
