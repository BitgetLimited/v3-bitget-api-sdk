...
class MarginCancelOrderRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["symbol", "clientOid", "orderId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["symbol", "clientOid", "orderId", ], str]):
