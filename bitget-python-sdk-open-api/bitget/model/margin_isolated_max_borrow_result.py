...
class MarginIsolatedMaxBorrowResult(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["coin", "maxBorrowableAmount", "symbol", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["coin", "maxBorrowableAmount", "symbol", ], str]):
