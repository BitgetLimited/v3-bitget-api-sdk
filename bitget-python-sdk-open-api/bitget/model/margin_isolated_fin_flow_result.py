...
class MarginIsolatedFinFlowResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginIsolatedFinFlowInfo']:
                        return MarginIsolatedFinFlowInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginIsolatedFinFlowInfo'], typing.List['MarginIsolatedFinFlowInfo']],
                ...
                def __getitem__(self, i: int) -> 'MarginIsolatedFinFlowInfo':
