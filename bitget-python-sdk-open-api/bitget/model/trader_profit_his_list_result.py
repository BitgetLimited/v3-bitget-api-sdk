...
class TraderProfitHisListResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TraderProfitHisResult']:
                        return TraderProfitHisResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TraderProfitHisResult'], typing.List['TraderProfitHisResult']],
                ...
                def __getitem__(self, i: int) -> 'TraderProfitHisResult':
