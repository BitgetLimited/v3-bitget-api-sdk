...
class ApiResponseResultOfTraderSettingResult(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['TraderSettingResult']:
                return TraderSettingResult
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'TraderSettingResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['TraderSettingResult', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['TraderSettingResult', schemas.Unset] = schemas.unset,
