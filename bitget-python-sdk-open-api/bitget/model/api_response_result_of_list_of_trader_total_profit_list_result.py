...
class ApiResponseResultOfListOfTraderTotalProfitListResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TraderTotalProfitListResult']:
                        return TraderTotalProfitListResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['TraderTotalProfitListResult'], typing.List['TraderTotalProfitListResult']],
                ...
                def __getitem__(self, i: int) -> 'TraderTotalProfitListResult':
