...
class MarginIsolatedLiquidationInfo(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ctime", "liqEndTime", "liqFee", "liqId", "liqRisk", "liqStartTime", "symbol", "totalAssets", "totalDebt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ctime", "liqEndTime", "liqFee", "liqId", "liqRisk", "liqStartTime", "symbol", "totalAssets", "totalDebt", ], str]):
