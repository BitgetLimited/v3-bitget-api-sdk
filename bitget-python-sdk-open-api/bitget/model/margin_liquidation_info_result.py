...
class MarginLiquidationInfoResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginLiquidationInfo']:
                        return MarginLiquidationInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginLiquidationInfo'], typing.List['MarginLiquidationInfo']],
                ...
                def __getitem__(self, i: int) -> 'MarginLiquidationInfo':
