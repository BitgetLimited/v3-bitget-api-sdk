...
class MarginBatchOrdersRequest(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class orderList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginOrderRequest']:
                        return MarginOrderRequest
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginOrderRequest'], typing.List['MarginOrderRequest']],
                ...
                def __getitem__(self, i: int) -> 'MarginOrderRequest':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["symbol", "channelApiCode", "ip", "orderList", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["symbol", "channelApiCode", "ip", "orderList", ], str]):
