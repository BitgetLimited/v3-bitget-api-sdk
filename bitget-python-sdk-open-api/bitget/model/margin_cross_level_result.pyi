...
class MarginCrossLevelResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["coin", "leverage", "maintainMarginRate", "maxBorrowableAmount", "tier", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["coin", "leverage", "maintainMarginRate", "maxBorrowableAmount", "tier", ], str]):
