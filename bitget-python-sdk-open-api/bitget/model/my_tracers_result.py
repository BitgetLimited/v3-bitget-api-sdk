        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MyTracerResult']:
                        return MyTracerResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MyTracerResult'], typing.List['MyTracerResult']],
                ...
                def __getitem__(self, i: int) -> 'MyTracerResult':
