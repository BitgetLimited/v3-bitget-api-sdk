...
class MarginCrossFinFlowResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginCrossFinFlowInfo']:
                        return MarginCrossFinFlowInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginCrossFinFlowInfo'], typing.List['MarginCrossFinFlowInfo']],
                ...
                def __getitem__(self, i: int) -> 'MarginCrossFinFlowInfo':
