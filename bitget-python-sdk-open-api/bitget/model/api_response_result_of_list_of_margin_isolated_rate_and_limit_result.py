        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginIsolatedRateAndLimitResult']:
                        return MarginIsolatedRateAndLimitResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginIsolatedRateAndLimitResult'], typing.List['MarginIsolatedRateAndLimitResult']],
                ...
                def __getitem__(self, i: int) -> 'MarginIsolatedRateAndLimitResult':
