...
class MarginIsolatedInterestInfo(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "ctime", "interestCoin", "interestId", "interestRate", "loanCoin", "symbol", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "ctime", "interestCoin", "interestId", "interestRate", "loanCoin", "symbol", "type", ], str]):
