...
class ApiResponseResultOfMarginIsolatedLiquidationInfoResult(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['MarginIsolatedLiquidationInfoResult']:
                return MarginIsolatedLiquidationInfoResult
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'MarginIsolatedLiquidationInfoResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['MarginIsolatedLiquidationInfoResult', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['MarginIsolatedLiquidationInfoResult', schemas.Unset] = schemas.unset,
