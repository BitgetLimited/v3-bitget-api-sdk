...
class ApiResponseResultOfVoid(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "msg", "requestTime", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "msg", "requestTime", ], str]):
