...
class ApiResponseResultOfMarginRepayInfoResult(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['MarginRepayInfoResult']:
                return MarginRepayInfoResult
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'MarginRepayInfoResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['MarginRepayInfoResult', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['MarginRepayInfoResult', schemas.Unset] = schemas.unset,
