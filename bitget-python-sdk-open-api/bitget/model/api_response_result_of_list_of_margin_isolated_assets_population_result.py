...
class ApiResponseResultOfListOfMarginIsolatedAssetsPopulationResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginIsolatedAssetsPopulationResult']:
                        return MarginIsolatedAssetsPopulationResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginIsolatedAssetsPopulationResult'], typing.List['MarginIsolatedAssetsPopulationResult']],
                ...
                def __getitem__(self, i: int) -> 'MarginIsolatedAssetsPopulationResult':
