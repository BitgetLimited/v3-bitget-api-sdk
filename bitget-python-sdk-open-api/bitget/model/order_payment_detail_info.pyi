...
class OrderPaymentDetailInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "required", "type", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "required", "type", "value", ], str]):
