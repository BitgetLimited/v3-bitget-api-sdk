...
class MarginIsolatedRepayInfoResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginIsolatedRepayInfo']:
                        return MarginIsolatedRepayInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginIsolatedRepayInfo'], typing.List['MarginIsolatedRepayInfo']],
                ...
                def __getitem__(self, i: int) -> 'MarginIsolatedRepayInfo':
