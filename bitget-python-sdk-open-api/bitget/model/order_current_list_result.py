...
class OrderCurrentListResult(
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrderCurrentResult']:
                        return OrderCurrentResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OrderCurrentResult'], typing.List['OrderCurrentResult']],
                ...
                def __getitem__(self, i: int) -> 'OrderCurrentResult':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["minId", "resultList", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["minId", "resultList", ], str]):
