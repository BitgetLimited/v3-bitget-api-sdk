...
class MarginIsolatedLiquidationInfoResult(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class resultList(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MarginIsolatedLiquidationInfo']:
                        return MarginIsolatedLiquidationInfo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MarginIsolatedLiquidationInfo'], typing.List['MarginIsolatedLiquidationInfo']],
                ...
                def __getitem__(self, i: int) -> 'MarginIsolatedLiquidationInfo':
