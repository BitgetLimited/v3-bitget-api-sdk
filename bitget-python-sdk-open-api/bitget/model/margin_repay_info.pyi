...
class MarginRepayInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "coin", "ctime", "interest", "repayId", "totalAmount", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "coin", "ctime", "interest", "repayId", "totalAmount", "type", ], str]):
