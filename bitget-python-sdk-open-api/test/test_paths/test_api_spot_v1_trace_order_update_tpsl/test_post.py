...
import bitget
from bitget.paths.api_spot_v1_trace_order_update_tpsl import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderUpdateTpsl(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderUpdateTpsl unit test stubs
        updateTpsl  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.spot_trace_update_tpsl(req)
                print(api_response)
