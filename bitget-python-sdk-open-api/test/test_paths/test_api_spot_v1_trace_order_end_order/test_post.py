...
import bitget
from bitget.paths.api_spot_v1_trace_order_end_order import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderEndOrder(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderEndOrder unit test stubs
        endOrder  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.spot_trace_end_order(req)
                print(api_response)
