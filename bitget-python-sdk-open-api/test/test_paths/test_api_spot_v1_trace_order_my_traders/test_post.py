...
import bitget
from bitget.paths.api_spot_v1_trace_order_my_traders import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderMyTraders(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderMyTraders unit test stubs
        myTraders  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = MyTradersRequest(
                    pageSize=10
                )
                api_response = api_instance.spot_trace_my_traders(req)
                print(api_response)
