...
import bitget
from bitget.paths.api_margin_v1_isolated_order_cancel_order import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedOrderCancelOrder(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedOrderCancelOrder unit test stubs
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.margin_isolated_cancel_order(req)
                print(api_response)
