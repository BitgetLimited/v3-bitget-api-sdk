...
import bitget
from bitget.paths.api_margin_v1_isolated_account_borrow import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedAccountBorrow(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedAccountBorrow unit test stubs
        borrow  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = MarginIsolatedLimitRequest(
                    coin="USDT",
                    borrowAmount="1",
                    symbol="BTCUSDT"
                )
                api_response = api_instance.margin_isolated_account_borrow(req)
                print(api_response)
                ...
                self.assertIsNotNone(api_response.body['data']['borrowAmount'])
