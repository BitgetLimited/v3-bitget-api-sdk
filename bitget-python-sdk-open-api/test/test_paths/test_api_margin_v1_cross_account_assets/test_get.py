...
import bitget
from bitget.paths.api_margin_v1_cross_account_assets import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossAccountAssets(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossAccountAssets unit test stubs
        assets  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.margin_cross_account_assets(req)
                print(api_response)
