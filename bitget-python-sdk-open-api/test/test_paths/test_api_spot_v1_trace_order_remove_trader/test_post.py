...
import bitget
from bitget.paths.api_spot_v1_trace_order_remove_trader import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderRemoveTrader(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderRemoveTrader unit test stubs
        removeTrader  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = RemoveTraderRequest(
                    traderUserId= "1232884851114008576",
                )
                api_response = api_instance.spot_trace_remove_trader(req)
                print(api_response)
