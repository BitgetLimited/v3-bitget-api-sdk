...
import bitget
from bitget.paths.api_margin_v1_isolated_account_assets import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedAccountAssets(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedAccountAssets unit test stubs
        assets  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.margin_isolated_account_assets(req)
                print(api_response)
                ...
                for item in api_response.body['data']:
                    ...
                    self.assertIsNotNone(item['frozen'])
                    self.assertIsNotNone(item['borrow'])
                    self.assertIsNotNone(item['interest'])
