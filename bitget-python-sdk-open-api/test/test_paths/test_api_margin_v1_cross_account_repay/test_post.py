...
import bitget
from bitget.paths.api_margin_v1_cross_account_repay import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossAccountRepay(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossAccountRepay unit test stubs
        repay  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = MarginCrossRepayRequest(
                    coin="USDT",
                    repayAmount="1"
                )
                api_response = api_instance.margin_cross_account_repay(req)
                print(api_response)
