...
import bitget
from bitget.paths.api_margin_v1_isolated_account_risk_rate import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedAccountRiskRate(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedAccountRiskRate unit test stubs
        riskRate  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = MarginIsolatedAssetsRiskRequest(
                    symbol="BTCUSDT"
                )
                api_response = api_instance.margin_isolated_account_risk_rate(req)
                print(api_response)
                ...
                for item in api_response.body['data']:
                    ...
                    self.assertIsNotNone(item['riskRate'])
