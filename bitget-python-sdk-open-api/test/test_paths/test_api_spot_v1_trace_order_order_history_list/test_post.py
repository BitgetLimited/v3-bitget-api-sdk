...
import bitget
from bitget.paths.api_spot_v1_trace_order_order_history_list import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderOrderHistoryList(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderOrderHistoryList unit test stubs
        orderHistoryList  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = HistoryOrderListRequest(
                    pageSize=10
                )
                api_response = api_instance.spot_trace_order_history_list(req)
                print(api_response)
                ...
                for item in api_response.body['data']['resultList']:
                    print(item)
                    self.assertIsNotNone(item['buyLeftTokenId'])
