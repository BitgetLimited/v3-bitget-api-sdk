...
import bitget
from bitget.paths.api_p2p_v1_merchant_merchant_list import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiP2pV1MerchantMerchantList(ApiTestMixin, unittest.TestCase):
    """
    ApiP2pV1MerchantMerchantList unit test stubs
        merchantList  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            api_instance = p2p_merchant_api.MerchantOrderList(api_client)
            try:
                req = {
                    'startTime': "1676260773000",
                }
                api_response = api_instance.merchant_order_list(req)
                print(api_response)
                ...
                for item in api_response.body['data']['orderList']:
                    ...
                    self.assertIsNotNone(item['orderNo'])
                    ...
                    self.assertIsNotNone(item['paymentInfo'])
