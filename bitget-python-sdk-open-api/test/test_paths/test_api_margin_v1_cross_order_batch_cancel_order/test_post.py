...
import bitget
from bitget.paths.api_margin_v1_cross_order_batch_cancel_order import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossOrderBatchCancelOrder(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossOrderBatchCancelOrder unit test stubs
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            api_instance = margin_cross_order_api.MarginCrossBatchCancelOrder(api_client)
            try:
                ...
                api_response = api_instance.margin_cross_batch_cancel_order(req)
                print(api_response)
