...
import bitget
from bitget.paths.api_margin_v1_isolated_order_batch_cancel_order import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedOrderBatchCancelOrder(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedOrderBatchCancelOrder unit test stubs
        batchCancelOrder  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            place_response = api_instance.margin_isolated_place_order(req)
            ...
            api_instance = margin_isolated_order_api.MarginIsolatedBatchCancelOrder(api_client)
            try:
                from bitget.model.margin_batch_cancel_order_request import MarginBatchCancelOrderRequest
                req = MarginBatchCancelOrderRequest(
                    symbol="BTCUSDT",
                    orderIds=[place_response.body['data']['orderId']]
                )
                api_response = api_instance.margin_isolated_batch_cancel_order(req)
                print(api_response)
