...
import bitget
from bitget.paths.api_margin_v1_cross_account_borrow import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossAccountBorrow(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossAccountBorrow unit test stubs
        borrow  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = MarginCrossLimitRequest(
                    coin="USDT",
                    borrowAmount="1"
                )
                api_response = api_instance.margin_cross_account_borrow(req)
                print(api_response)
