...
import bitget
from bitget.paths.api_margin_v1_isolated_order_open_orders import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedOrderOpenOrders(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedOrderOpenOrders unit test stubs
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.margin_isolated_open_orders(req)
                print(api_response)
