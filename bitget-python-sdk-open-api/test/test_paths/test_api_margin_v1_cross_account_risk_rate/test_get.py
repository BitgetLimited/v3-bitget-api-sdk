...
import bitget
from bitget.paths.api_margin_v1_cross_account_risk_rate import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossAccountRiskRate(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossAccountRiskRate unit test stubs
        riskRate  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                self.assertIsNotNone(api_response.body['data']['riskRate'])
