...
import bitget
from bitget.paths.api_margin_v1_isolated_order_batch_place_order import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedOrderBatchPlaceOrder(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedOrderBatchPlaceOrder unit test stubs
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.margin_isolated_batch_place_order(req)
                print(api_response)
