...
import bitget
from bitget.paths.api_margin_v1_cross_account_max_transfer_out_amount import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossAccountMaxTransferOutAmount(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossAccountMaxTransferOutAmount unit test stubs
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.margin_cross_account_max_transfer_out_amount(req)
                print(api_response)
