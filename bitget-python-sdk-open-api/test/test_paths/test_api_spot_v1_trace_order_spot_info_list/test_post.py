...
import bitget
from bitget.paths.api_spot_v1_trace_order_spot_info_list import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderSpotInfoList(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderSpotInfoList unit test stubs
        spotInfoList  # noqa: E501
    """
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                for item in api_response.body['data']:
                    ...
                    self.assertIsNotNone(item['surplusCount'])
                    self.assertIsNotNone(item['maxCount'])
