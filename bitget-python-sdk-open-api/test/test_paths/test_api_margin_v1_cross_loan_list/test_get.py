...
import bitget
from bitget.paths.api_margin_v1_cross_loan_list import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossLoanList(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossLoanList unit test stubs
        list  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.cross_loan_list(req)
                print(api_response)
