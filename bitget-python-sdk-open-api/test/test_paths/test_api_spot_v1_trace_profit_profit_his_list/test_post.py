...
import bitget
from bitget.paths.api_spot_v1_trace_profit_profit_his_list import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceProfitProfitHisList(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceProfitProfitHisList unit test stubs
        profitHisList  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.spot_trace_profit_his_list(req)
                print(api_response)
