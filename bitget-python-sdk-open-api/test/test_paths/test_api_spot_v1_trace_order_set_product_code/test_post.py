...
import bitget
from bitget.paths.api_spot_v1_trace_order_set_product_code import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderSetProductCode(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderSetProductCode unit test stubs
        setProductCode  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = ProductCodeRequest(
                    symbolIds= ["BTCUSDT_SPBL", "ETHUSDT_SPBL", "BGBUSDT_SPBL"]
                )
                api_response = api_instance.spot_trace_set_product_code(req)
                print(api_response)
