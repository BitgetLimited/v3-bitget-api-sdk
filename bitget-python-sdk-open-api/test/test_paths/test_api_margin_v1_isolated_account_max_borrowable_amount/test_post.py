...
import bitget
from bitget.paths.api_margin_v1_isolated_account_max_borrowable_amount import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedAccountMaxBorrowableAmount(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedAccountMaxBorrowableAmount unit test stubs
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            api_instance = margin_isolated_account_api.MarginIsolatedAccountMaxBorrowableAmount(api_client)
            try:
                from bitget.model.margin_isolated_max_borrow_request import MarginIsolatedMaxBorrowRequest
                req = MarginIsolatedMaxBorrowRequest(
                    coin="USDT",
                    symbol="BTCUSDT"
                )
                api_response = api_instance.margin_isolated_account_max_borrowable_amount(req)
                print(api_response)
