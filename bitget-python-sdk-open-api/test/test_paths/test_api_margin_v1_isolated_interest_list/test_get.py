...
import bitget
from bitget.paths.api_margin_v1_isolated_interest_list import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1IsolatedInterestList(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1IsolatedInterestList unit test stubs
        list  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                api_response = api_instance.isolated_interest_list(req)
                print(api_response)
