...
import bitget
from bitget.paths.api_spot_v1_trace_order_close_tracking_order import post  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiSpotV1TraceOrderCloseTrackingOrder(ApiTestMixin, unittest.TestCase):
    """
    ApiSpotV1TraceOrderCloseTrackingOrder unit test stubs
        closeTrackingOrder  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            try:
                ...
                req = CloseTrackingOrderRequest(
                    symbolId = "BTCUSDT_SPBL",
                    trackingOrderNos = ["1032884851114008576"],
                )
                api_response = api_instance.spot_trace_close_tracking_order(req)
                print(api_response)
