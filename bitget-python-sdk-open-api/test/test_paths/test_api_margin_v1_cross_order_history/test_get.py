...
import bitget
from bitget.paths.api_margin_v1_cross_order_history import get  # noqa: E501
from bitget import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiMarginV1CrossOrderHistory(ApiTestMixin, unittest.TestCase):
    """
    ApiMarginV1CrossOrderHistory unit test stubs
        history  # noqa: E501
    """
    ...
    def testApi(self):
        ...
        with bitget.ApiClient(configuration) as api_client:
            ...
            api_instance = margin_cross_order_api.MarginCrossHistoryOrders(api_client)
            try:
                req = {
                    'symbol':"BTCUSDT",
                    'startTime': "1679133422000",
                }
                api_response = api_instance.margin_cross_history_orders(req)
                print(api_response)
