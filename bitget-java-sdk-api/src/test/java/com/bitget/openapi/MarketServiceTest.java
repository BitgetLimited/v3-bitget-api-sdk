...
public class MarketServiceTest extends BaseTest {
    ...
    public void getCandles() throws IOException {
        List<Object[]> result = bitgetRestClient.contract().bitget().market().getCandles(symbol, "2020-06-28T10:00:12.000Z", "2020-06-28T16:00:12.000Z", "60");
        System.out.println(JSON.toJSONString(result));
    }
    ...
    public void getHistoricalFundingRateApi() throws IOException {
        List<HistoricalFundingRate> result = bitgetRestClient.contract().bitget().market().getHistoricalFundingRateApi(symbol, "1", "2", "50");
        System.out.println(JSON.toJSONString(result));
    }
