...
/**
 * CurrentOrderListRequest Class Doc Comment
 *
 * @category Class
 * @package  Bitget
 * @author   OpenAPI Generator team
 ...
 */
class CurrentOrderListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrentOrderListRequest';
    ...
    {
        $this->setIfExists('mix_id', $data ?? [], null);
    ...
    */
     ...
     * Sets mix_id
     *
     * @param string|null $mix_id mixId
     *
     * @return self
     */
    public function setMixId($mix_id)
    {
        ...
        if (is_null($mix_id)) {
            throw new \InvalidArgumentException('non-nullable mix_id cannot be null');
        }
     ...
     * Sets page_size
     *
     * @param string|null $page_size pageSize
     *
     * @return self
     */
     ...
     * Sets tracking_no
     *
     * @param string|null $tracking_no trackingNo
     *
     * @return self
     */
