...
/**
 * MarginIsolatedLoanInfo Class Doc Comment
 *
 * @category Class
 * @package  Bitget
 * @author   OpenAPI Generator team
 ...
 */
class MarginIsolatedLoanInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarginIsolatedLoanInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('loan_id', $data ?? [], null);
    ...
    */
     ...
     * Sets loan_id
     *
     * @param string|null $loan_id loan_id
     *
     * @return self
     */
    public function setLoanId($loan_id)
    {
        ...
        if (is_null($loan_id)) {
            throw new \InvalidArgumentException('non-nullable loan_id cannot be null');
        }
