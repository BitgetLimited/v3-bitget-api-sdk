...
/**
 * MarginIsolatedBorrowLimitResult Class Doc Comment
 *
 * @category Class
 * @package  Bitget
 * @author   OpenAPI Generator team
 ...
 */
class MarginIsolatedBorrowLimitResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarginIsolatedBorrowLimitResult';
    ...
    {
        $this->setIfExists('borrow_amount', $data ?? [], null);
    ...
    */
     ...
     * Sets borrow_amount
     *
     * @param string|null $borrow_amount borrow_amount
     *
     * @return self
     */
    public function setBorrowAmount($borrow_amount)
    {
        ...
        if (is_null($borrow_amount)) {
            throw new \InvalidArgumentException('non-nullable borrow_amount cannot be null');
        }
