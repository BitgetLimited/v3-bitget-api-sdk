...
/**
 * MarginIsolatedRepayResult Class Doc Comment
 *
 * @category Class
 * @package  Bitget
 * @author   OpenAPI Generator team
 ...
 */
class MarginIsolatedRepayResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarginIsolatedRepayResult';
    ...
    protected static $attributeMap = [
        ...
        'coin' => 'coin',
        'remain_debt_amount' => 'remainDebtAmount',
    ...
    protected static $setters = [
        ...
        'coin' => 'setCoin',
        'remain_debt_amount' => 'setRemainDebtAmount',
    ...
    protected static $getters = [
        ...
        'coin' => 'getCoin',
        'remain_debt_amount' => 'getRemainDebtAmount',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('remain_debt_amount', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets remain_debt_amount
     *
     * @return string|null
     */
    public function getRemainDebtAmount()
    {
        return $this->container['remain_debt_amount'];
    }

    /**
     * Sets remain_debt_amount
     *
     * @param string|null $remain_debt_amount remain_debt_amount
     *
     * @return self
     */
    public function setRemainDebtAmount($remain_debt_amount)
    {

        if (is_null($remain_debt_amount)) {
            throw new \InvalidArgumentException('non-nullable remain_debt_amount cannot be null');
        }

        $this->container['remain_debt_amount'] = $remain_debt_amount;
     ...
     * Sets repay_amount
     *
     * @param string|null $repay_amount repay_amount
     *
     * @return self
     */
