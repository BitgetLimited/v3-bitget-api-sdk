...
/**
 * MarginCrossRepayApiTest Class Doc Comment
 *
 * @category Class
 * @package  Bitget
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MarginCrossRepayApiTest extends TestCase
{
    private $config;
    ...
    public function setUp(): void
    {
        ...
        $this->apiInstance = new \Bitget\Api\MarginCrossRepayApi(
    ...
    {
        try {
            $result = $this->apiInstance->crossRepayList("1679133422000");
            print_r($result);
