...
/**
 * MarginIsolatedBorrowApiTest Class Doc Comment
 *
 * @category Class
 * @package  Bitget
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MarginIsolatedBorrowApiTest extends TestCase
{
    private $config;
    ...
    public function setUp(): void
    {
        ...
        $this->apiInstance = new \Bitget\Api\MarginIsolatedBorrowApi(
    ...
    {
        try {
            $result = $this->apiInstance->isolatedLoanList("BTCUSDT", "1679133422000");
            print_r($result);
